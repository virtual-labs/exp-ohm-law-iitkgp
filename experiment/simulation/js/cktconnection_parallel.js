...
prepare1 = function (elId) {
    ...
    document.getElementById("check-button").addEventListener("click", function () {
        ...
        var is_connected_3_10 = false;
        var is_connected_4_11 = false;
        var is_connected_10_7 = false;
        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_3_10){
                is_connected_3_10 = correct_connections_3_10.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_10_7){
                is_connected_10_7 = correct_connections_10_7.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
        ...
        if (is_connected_1_3 && is_connected_3_10 && is_connected_10_7 && is_connected_8_11 && is_connected_9_12 && is_connected_6_9 && is_connected_4_11&& is_connected_4_5 && !unallowed_connection_present) {
