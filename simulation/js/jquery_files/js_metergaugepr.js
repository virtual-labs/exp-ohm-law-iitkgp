...
/* Document Name: js_metergaugepr.js
...
//r2=20000000;
   ...
   r = ((parseInt(r1) * parseInt(r2) ) / (parseInt(r1) + parseInt(r2))); //kohm
//alert("rtol" +r);
    z = v / r;
    ...
    document.getElementById("amp").value = (z).toPrecision(3); //Ammeter reading //mAmp
